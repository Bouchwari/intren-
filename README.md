...
- يتحقق البرنامج من وجود تحديث بعد تشغيله دون تعطيل العمل، ويعرض للمستخدم
  رقم الإصدار الجديد وما تغير فيه وزر تنزيل مباشر. عند غياب الإنترنت يستمر
  البرنامج بشكل عادي دون إظهار رسالة خطأ.
...
- إنشاء نموذج Excel لعدة أيام، ثم استيراده لحفظ الحضور والغياب الحقيقي دفعة
  واحدة، دون الحاجة إلى إكمال لائحة التلاميذ أولاً. تُحسب خانة الغياب الفارغة
  بقيمة 0 ويمكن تعديلها لاحقاً.
...
- ملف التشغيل أو التثبيت: حوالي 70 MB.
