...
report — for a single date. Used by ui/work_pipeline_screen.py so the
مسير sees at a glance what's done and what still needs attention,
instead of opening all 3 daily screens to check by hand.
"""
from dataclasses import dataclass
from typing import List

from data.database import get_day_absences, get_day_contacts, get_daily_report
...
def get_daily_pipeline_status(date_str: str) -> List[PipelineItem]:
    """Status of the 3 daily documents for date_str (YYYY-MM-DD)."""
